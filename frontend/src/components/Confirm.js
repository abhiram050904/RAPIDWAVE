...
const ConfirmContainer = styled.div`
  ...
  height: 100vh;
  background-color: #bff2f1; /* Set background color to #bff2f1 */
`;
...
const MapContainer = styled.div`
  height: calc(50vh - 4px); /* Adjust height to account for border */
  width: 90%; /* Reduced width */
  margin: 0 auto;
  border: 2px solid #333; /* Adds a border around all sides */
  box-sizing: border-box; /* Ensures the border is included in the width and height */
  position: sticky;
  top: 0;
`;
...
// Assuming this is in RideSelector component's CSS or styled-components
const FareButton = styled.button`
  width: 80%; /* Adjust width to reduce size horizontally */
  margin: 0.5rem auto;
  padding: 10px;
  font-size: 14px;
  display: block;
